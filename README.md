...
[![GitHub](http://img.shields.io/badge/github-zuazo/alpine--tor--docker-blue.svg?style=flat)](https://github.com/zuazo/alpine-tor-docker) [![](https://images.microbadger.com/badges/image/zuazo/alpine-tor.svg)](https://microbadger.com/images/zuazo/alpine-tor "Get your own image badge on microbadger.com") [![Docker Repository on Quay.io](https://quay.io/repository/zuazo/alpine-tor/status 'Docker Repository on Quay.io')](https://quay.io/repository/zuazo/alpine-tor) [![Build Status](http://img.shields.io/travis/zuazo/alpine-tor-docker.svg?style=flat)](https://travis-ci.org/zuazo/alpine-tor-docker)
